...
<div class="col-lg-12 text-center ">
    <h1 style="font-family:Lucida Console">Hotel Management System</h1>
</div>
...
<body class="login" style="margin-top: -20px;">
    ...
    <div class="login_wrapper">
            ...
            <?php
                ...
                {
                    mysqli_query($link , "insert into admin_registration values('' , '$_POST[firstname]' , '$_POST[lastname]', '$_POST[username]' , '$_POST[password]' , '$_POST[email]' ,'$_POST[contact]')")
